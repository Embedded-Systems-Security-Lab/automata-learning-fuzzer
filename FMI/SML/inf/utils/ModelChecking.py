...
import FMI.SML.inf.paths
from FMI.SML.inf.SULs import MealySUL
from FMI.SML.inf.automata import Mdp, StochasticMealyMachine, MealyMachine, MealyState
from FMI.SML.inf.base import DeterministicAutomaton, SUL, AutomatonState
...
def stop_based_on_confidence(hypothesis, property_based_stopping, print_level=2):
    ...
    """
    from FMI.SML.inf.automata.StochasticMealyMachine import smm_to_mdp_conversion
...
def model_check_properties(model: Mdp, properties: str):
    ...
    from FMI.SML.inf.utils import mdp_2_prism_format
...
def evaluate_all_properties(prism_file_name, properties_file_name):
    ...
    prism_file = FMI.SML.inf.paths.path_to_prism.split('/')[-1]
